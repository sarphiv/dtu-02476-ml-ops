...
REPO_NAME = dtu-02476-ml-ops
PACKAGE_NAME = ml_backend
PYTHON_VERSION = 3.10
...
create_environment:
	conda create --name $(REPO_NAME) python=$(PYTHON_VERSION) --no-default-packages -y
...
data: requirements
	$(PYTHON_INTERPRETER) src/$(PACKAGE_NAME)/data/make_dataset.py
